...
weight: 1
description: >
    Reference for the Redis Feature Modules API
aliases:
...
- [Reply APIs](#reply-apis)
  - [Reply with collection functions](#reply-with-collection-functions)
...
- [Calling Redis commands from modules](#calling-redis-commands-from-modules)
...
- [Modules EventLoop API](#modules-eventloop-api)
...
- [RDB load/save API](#rdb-loadsave-api)
...
- [Key eviction API](#key-eviction-api)
