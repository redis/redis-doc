...
Redis Cluster also provides some degree of availability during partitions&mdash;in practical terms, the ability to continue the operations when some nodes fail or are unable to communicate. 
