...
You can alternatively follow the instructions under the [installation section](/docs/install/) of this documentation site to install Redis on your local machine.
