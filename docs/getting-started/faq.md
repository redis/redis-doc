...
As a result of this, it is common for users with many keys with an expire set to see fewer keys in the replicas. Because of this artifact, there is no actual logical difference in the instance's content.
