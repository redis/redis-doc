...
Trivia: the Reddit 1st April fool project [r/place](https://reddit.com/r/place) was [built using the Redis BITFIELD command](https://redditblog.com/2017/04/13/how-we-built-rplace/) in order to take an in memory representation of the collaborative canvas.
