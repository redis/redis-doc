Return the positions (longitude,latitude) of all the speciied members of the geospatial index represented by the sorted set at *key*.
...
The command can accept a variable number of arguments so it always returns an array of positions even when a signle element is specified.
