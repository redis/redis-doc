The `SAVE` commands performs a **synchronous** save of all the dataset producing a *point in time* snapshot of all the data inside the Redis instance, in the form of an RDB file.
