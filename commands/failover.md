This command will start a coordinated failover between a master and one of its replicas.
...
This can be used for a best effort attempt at a failover without dataloss, but limiting write outage.
