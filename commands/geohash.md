...
Normally Redis represents the positions of elements using a variation of the Geohash
...
described in the [Wikipedia article](https://en.wikipedia.org/wiki/Geohash) and compatible with the [geohash.org](http://geohash.org) website.
...
each member name passed as an argument to the command.
