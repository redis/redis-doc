Return valid [Geohash](https://en.wikipedia.org/wiki/Geohash) strings representing the position of one or more members in a [Redis geospatial index](/docs/data-types/geospatial).
