...
* Sorted Sets are probably the most advanced Redis data types, so take some time to check the [full list of Hash commands](/commands#zset) to discover what you can do with Redis!
