...
* It is possible to build safer queues or rotating queues using `RPOPLPUSH` or `LMOVE`.
* There are also blocking variants of the commands, called `BRPOPLPUSH` and `BLMOVE`.
