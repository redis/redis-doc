...
* [Implementing native data types](/topics/modules-native-types.md) covers the implementation of native data types into modules.
* [Blocking operations](/topics/modules-blocking-ops.md) shows how to write blocking commands that will not reply immediately, but will block the client, without blocking the Redis server, and will provide a reply whenever will be possible.
* [Redis modules API reference](/topics/modules-api-ref.md) is generated from module.c top comments of RedisModule functions. It is a good reference in order to understand how each function works.
